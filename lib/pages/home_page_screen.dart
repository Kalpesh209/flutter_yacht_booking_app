...
class _HomePageBodyState extends State<HomePageScreen> {
  @override
  @override
          ...
          Expanded(
            child: Container(
              child: ListView(
                ...
                children: <Widget>[
                  _popularYatch(
                    'assets/image/yatch_side_2.png',
                    'Oceana Yatch',
                    " 4.5",
                  ),
                  _popularYatch(
                    'assets/image/yatch_side_1.png',
                    'Ardena Yatch',
                    " 3.2",
                  ),
                  _popularYatch(
